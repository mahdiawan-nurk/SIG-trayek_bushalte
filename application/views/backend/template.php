...
<body>
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
               ...
               <!--  <div class="col-sm-7">
                ...
                <div class="col-sm-4" style="padding-top: 2px"><label style="float: right;">Administrator</label></div>
    ...
    <script>
    var map = L.map('vmap').setView([0.3384284367413872, 101.01808547973633], 13);
